...
USERNAME=$(whoami)
HOSTNAME=$(hostname)
export UUID=${UUID:-'e02dbcbc-a233-410b-adcd-c188c41088f1'}
...
export ARGO_DOMAIN=${ARGO_DOMAIN:-'fq.fa666.cloudns.ch'}      # ARGO 固定隧道域名，留空将使用临时隧道
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiNTA0NmI1ODdjNmU0YmRhN2FlNTM2ZGZjZGVjM2M1NDkiLCJ0IjoiOTZiZTY5NDgtMTMyOS00OTIzLWEwMjktYzA2MDMxMGNlMDhlIiwicyI6IlpXTXhNelZqT0dRdE9EQmhPUzAwTlRNeUxXSTJNVEl0TmpjMFpEQTJNVFF5T1RBMyJ9'}         # ARGO 固定隧道json或token，留空将使用临时隧道
export CFIP=${CFIP:-'www.visa.com.tw'}   # 优选ip或优选域名
export CFPORT=${CFPORT:-'443'}          # 优选ip或优选域名对应端口  
export PORT=${PORT:-'44082'}           # ARGO端口必填
